...
<body>
	<div style="width: 100%; height: 98px; background-color: #014A95;">
		...
		<div id="head-nav-show" style="float: left; width: 700px; height: 100%;margin-left: 112px;">
			<div style="margin-top: 25px; float: right; width: 211px; height: 35px; background-color: #579EC8;line-height: 35px;text-align: center;">
