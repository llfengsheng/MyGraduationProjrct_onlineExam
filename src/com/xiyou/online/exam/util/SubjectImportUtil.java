package com.xiyou.online.exam.util;
	...
	public static List<SubjectInfo> parseSubjectExcel(String filePath, Integer courseId, Integer gradeId) {
		...
		try {
			...
			for (int i = 1; i <= sumRow; i++) {
				...
				subject.setOptionA(optionA.toString());
				subject.setOptionB(optionB.toString());
				subject.setOptionC(optionC.toString());
				subject.setOptionD(optionD.toString());
